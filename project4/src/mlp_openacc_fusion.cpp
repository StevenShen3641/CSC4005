...
#pragma acc data copyin(input_array[0 : input_num * input_dim], label_array[0 : input_num])     \
    copyout(label_array_batch[0 : batch_num * class_num], fc_1_mid[0 : batch_num * hidden_num], \
...
#pragma acc data copyin(test_data->images_matrix[0 : test_data->images_num * test_data->input_dim], W1[0 : size_weight1], W2[0 : size_weight2], b1[0 : size_bias1], b2[0 : size_bias2])
    {
